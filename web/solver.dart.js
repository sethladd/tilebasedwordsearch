...
$$.Stopwatch = {"": "Object;_liblib1$_start,_stop",
  start$0: function() {
    ...
    if (this._liblib1$_start == null)
      ...
      this._liblib1$_start = $.Primitives_numMicroseconds() - $.$$sub$n(this._stop, this._liblib1$_start);
      this._stop = null;
    }
  },
  stop$0: function() {
  ...
  get$elapsedTicks: function() {
    ...
    if (t1 == null)
      return 0;
    t2 = this._stop;
    return t2 == null ? $.$$sub$n($.Stopwatch__now(), this._liblib1$_start) : $.$$sub$n(t2, t1);
  },
...
$$.main_anon = {"": "Closure;numWords_0,resultsWords_1,resultsLength_2,time_3,grid_4,words_5",
  call$1: function(contents) {
    var t1, t2, sw, results;
    t1 = $.split$1$s(contents, "\n");
    t2 = this.words_5;
    $.CONSTANT2.forEach$1(t1, new $.main__anon(t2));
    t1 = $.S($.get$length$as(t2));
    this.numWords_0.set$text(t1);
    sw = $.Stopwatch$();
    sw.start$0();
    results = $.toList$0$a($.findAll(this.grid_4, t2));
    sw.stop$0();
    t1 = $.S(results);
    this.resultsWords_1.set$text(t1);
    t1 = $.S($.get$length$as(results));
    this.resultsLength_2.set$text(t1);
    t1 = "Found in " + $.S(sw.get$elapsedMilliseconds()) + " ms";
    this.time_3.set$text(t1);
  }
};

$$.main__anon = {"": "Closure;words_6",
  call$1: function(line) {
    $.$$indexSet$a(this.words_6, line, true);
    return true;
  }
};
...
$.main = function() {
  var numWords, resultsWords, resultsLength, time, words;
  numWords = document.query$1("#num-words");
  resultsWords = document.query$1("#results-words");
  resultsLength = document.query$1("#results-length");
  time = document.query$1("#time");
  words = $.HashMap$();
  $.HttpRequest_getString("assets/dictionary.txt", null, null).then$1(new $.main_anon(numWords, resultsWords, resultsLength, time, $.CONSTANT, words)).catchError$1(new $.main_anon0());
};
...
$._solve = function(x, y, word) {
  var t1, t4, newWord, _x, nX, _y, nY, t2;
  if (typeof x !== "number")
    return $._solve$bailout(1, x, y, word);
  if (typeof y !== "number")
    return $._solve$bailout(1, x, y, word);
  t1 = $.get$_visited();
  if (typeof t1 !== "string" && (typeof t1 !== "object" || t1 === null || t1.constructor !== Array && !t1.$isJavaScriptIndexingBehavior()))
    return $._solve$bailout(2, x, y, word, t1);
  if (x !== (x | 0))
    throw $.iae(x);
  if (x < 0 || x >= t1.length)
    throw $.ioore(x);
  t1 = t1[x];
  if (typeof t1 !== "object" || t1 === null || (t1.constructor !== Array || !!t1.immutable$list) && !t1.$isJavaScriptIndexingBehavior())
    return $._solve$bailout(3, x, y, word, t1);
  if (y !== (y | 0))
    throw $.iae(y);
  if (y < 0 || y >= t1.length)
    throw $.ioore(y);
  ...
  if (typeof t4 !== "string" && (typeof t4 !== "object" || t4 === null || t4.constructor !== Array && !t4.$isJavaScriptIndexingBehavior()))
    return $._solve$bailout(4, x, y, 0, t1, t4);
  if (x >= t4.length)
    throw $.ioore(x);
  t4 = t4[x];
  if (typeof t4 !== "string" && (typeof t4 !== "object" || t4 === null || t4.constructor !== Array && !t4.$isJavaScriptIndexingBehavior()))
    return $._solve$bailout(5, x, y, 0, t1, t4);
  if (y >= t4.length)
    throw $.ioore(y);
  newWord = t1 + $.S(t4[y]);
  if ($._words.containsKey$1(newWord) === true)
    $.$$indexSet$a($.get$_found(), newWord, true);
  for (_x = -1; _x < 2; ++_x) {
    nX = x + _x;
    if (nX < 0 || nX > 3)
      continue;
    for (t1 = _x === 0, _y = -1; _y < 2; ++_y) {
      if (t1 && _y === 0)
        continue;
      nY = y + _y;
      if (nY < 0 || nY > 3)
      ...
      t2 = $.get$_visited();
      if (typeof t2 !== "string" && (typeof t2 !== "object" || t2 === null || t2.constructor !== Array && !t2.$isJavaScriptIndexingBehavior()))
        return $._solve$bailout(6, x, y, 0, $.CONSTANT6, t2, $.CONSTANT6, nY, newWord, t1, _x, _y, nX);
      if (nX < 0 || nX >= t2.length)
        throw $.ioore(nX);
      t2 = t2[nX];
      if (typeof t2 !== "string" && (typeof t2 !== "object" || t2 === null || t2.constructor !== Array && !t2.$isJavaScriptIndexingBehavior()))
        return $._solve$bailout(7, x, y, 0, $.CONSTANT6, t2, $.CONSTANT6, nY, newWord, t1, _x, _y, nX);
      if (nY < 0 || nY >= t2.length)
        throw $.ioore(nY);
      t2 = t2[nY];
      if (typeof t2 !== "boolean")
        return $._solve$bailout(8, x, y, 0, $.CONSTANT6, t2, $.CONSTANT6, nY, newWord, t1, _x, _y, nX);
      if (t2)
        continue;
  ...
  t1 = $.get$_visited();
  if (typeof t1 !== "string" && (typeof t1 !== "object" || t1 === null || t1.constructor !== Array && !t1.$isJavaScriptIndexingBehavior()))
    return $._solve$bailout(9, x, y, 0, t1);
  if (x >= t1.length)
    throw $.ioore(x);
  t1 = t1[x];
  if (typeof t1 !== "object" || t1 === null || (t1.constructor !== Array || !!t1.immutable$list) && !t1.$isJavaScriptIndexingBehavior())
    return $._solve$bailout(10, 0, y, 0, t1);
  if (y >= t1.length)
    throw $.ioore(y);
  t1[y] = false;
};

$._solve$bailout = function(state0, x, y, word, t1, t4, t2, nY, newWord, t3, _x, _y, nX) {
  switch (state0) {
    case 0:
    case 1:
      state0 = 0;
            ...
            default:
              c$0: {
                switch (state0) {
                  case 0:
                    nX = t1.$add(x, _x);
                    t3 = $.getInterceptor$n(nX);
                    if (t3.$lt(nX, 0) === true || t3.$gt(nX, 3) === true)
                      break c$0;
                    t3 = _x === 0;
                    _y = -1;
                  default:
                              ...
                              switch (state0) {
                                case 0:
                                  if (t3 && _y === 0)
                                    break c$1;
                                  nY = t2.$add(y, _y);
                                  t4 = $.getInterceptor$n(nY);
                                  if (t4.$lt(nY, 0) === true || t4.$gt(nY, 3) === true)
                                    break c$1;
                                  t4 = $.get$_visited();
                                case 6:
                                  state0 = 0;
...
$.CONSTANT15 = Isolate.makeConstantList(["E", "F", "G", "H"]);
$.CONSTANT1 = new $.NullThrownError();
$.CONSTANT6 = new $.JSNumber();
$.CONSTANT2 = new $.JSArray();
$.CONSTANT16 = Isolate.makeConstantList(["I", "J", "K", "L"]);
...
$.CONSTANT17 = Isolate.makeConstantList(["M", "N", "O", "P"]);
$.CONSTANT12 = new $.Object();
$.CONSTANT13 = Isolate.makeConstantList([]);
$.CONSTANT10 = new $.EventStreamProvider("load");
$.CONSTANT18 = Isolate.makeConstantList(["A", "B", "C", "D"]);
$.CONSTANT0 = new $.EventStreamProvider("error");
$.CONSTANT = Isolate.makeConstantList([$.CONSTANT18, $.CONSTANT15, $.CONSTANT16, $.CONSTANT17]);
...
Isolate.$lazy($, "_visited", "_visited", "get$_visited", function() {
  return $.List_List$generate(4, new $.anon(), true);
});
Isolate.$lazy($, "_found", "_found", "get$_found", function() {
  return $.Map_Map();
});
var $ = null;
...
$.$defineNativeClass("Document", {
  query$1: function(selectors) {
    if ($.RegExp_RegExp("^#[_a-zA-Z]\\w*$", true, false).hasMatch$1(selectors))
      return this.getElementById($.CONSTANT7.substring$1(selectors, 1));
